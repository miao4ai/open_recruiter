...
Wrapped in try/except so a failure here never prevents the app from starting.
"""
...
try:
    ...
    if not _registered:
        # Fallback: monkey-patch _find_constructors
    ...
    # Never let the hook crash the application
    pass
